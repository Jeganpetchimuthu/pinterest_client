  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://pinterest-serer.onrender.com/api/signup",
        {
          email,
          password,
        }
    ...
    <div className="sign-container">
      ...
      <form className="form-sign" onSubmit={handleSubmit}>
        ...
        <button className="fb-button">
          <span>
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHtcm4I8GQc8E1s2qNyKijpFvqpoKtz-n0ZHlw28SDFct8nvfbid1DjkQhBo5HZqDv8PU&usqp=CAU"
              alt="fblogo"
              width={"24px"}
              height={"24px"}
              className="fblogos"
